...
🔗 **GitHub**: [https://github.com/Salamander5876/SystemVoitesParus](https://github.com/Salamander5876/SystemVoitesParus)
...
Вся установка происходит под root правами и зарегистрированным доменом
...
```bash
# Клонирование репозитория
git clone https://github.com/Salamander5876/SystemVoitesParus.git
cd SystemVoitesParus
